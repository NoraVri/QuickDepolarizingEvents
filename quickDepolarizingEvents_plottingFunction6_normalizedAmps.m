function [] = quickDepolarizingEvents_plottingFunction6_normalizedAmps(Vtraces_columns,time_axis,VpeaksIdcs_cellArray,baseline_Vs_cellArray)
...
%         tracei_QDE_colorNos = ceil(tracei_baselineVs - overall_min_baselineV) + 1;
        ...
        for j = 1:length(tracei_VpeaksIdcs)
            ...
            plot(windowed_time_axis,QDEj_Vtrace_baselined_normalized,'k');
        end
    end
end
% bar = colorbar;
